...
export default async function handler(
  ...
  if (req.method === "PUT") {
    ...
    try {
      ...
      // Enforce the financer-access cap when granting. Count other users who
      // already hold the flag; reject once the maximum is reached. (Revoking
      // and all other updates are unaffected.)
